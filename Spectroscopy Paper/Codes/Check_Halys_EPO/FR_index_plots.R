...
csv_files <- list.files(path = paste0(path_to_data, "/index_org_trsfed_crp_sl"), pattern = "\\.csv$", full.names = FALSE)
...
for (name in unique(csv_files)) {
  ...
  NDTI_transformed <- read.csv(paste0(path_to_data,'index_org_trsfed_crp_sl/NDTI_transformed_',name, '.csv'))
  NDTI_original <- read.csv(paste0(path_to_data, 'index_org_trsfed_crp_sl/NDTI_Original_', name, '.csv'))
  
  CAI_transformed <- read.csv(paste0(path_to_data, 'index_org_trsfed_crp_sl/CAI_transformed_', name, '.csv'))
  CAI_original <- read.csv(paste0(path_to_data, 'index_org_trsfed_crp_sl/CAI_Original_', name, '.csv'))
  
  SINDRI_transformed <- read.csv(paste0(path_to_data, 'index_org_trsfed_crp_sl/SINDRI_transformed_', name, '.csv'))
  ...
  theme(
    ...
    ggsave(paste0(path_to_plots, "FR~Index/", name, ".png"), width = 21, height = 14.8, units = "cm")
}
