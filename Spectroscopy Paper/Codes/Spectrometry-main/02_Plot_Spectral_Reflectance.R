...
# Residue_Median <- read.csv("G:\My Drive\PhD\Projects\Spectroscopy paper\Spectrometry-main\Residue_08_18.csv")
# Soil_Median <- read.csv("G:\My Drive\PhD\Projects\Spectroscopy paper\Spectrometry-main\Soil_08_18.csv")
