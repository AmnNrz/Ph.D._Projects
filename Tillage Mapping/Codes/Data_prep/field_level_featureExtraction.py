...
# + colab={"base_uri": "https://localhost:8080/"} id="rGJfduanSJ3L" executionInfo={"status": "ok", "timestamp": 1676954898731, "user_tz": 480, "elapsed": 163, "user": {"displayName": "amin norouzi", "userId": "02798455485104728835"}} outputId="72ab13e2-8f0c-4f64-9fd1-5640d05b5a83"
# noJump_df.columns
...
# + colab={"base_uri": "https://localhost:8080/"} id="Z7HTdvp-jatT" executionInfo={"status": "ok", "timestamp": 1677008351228, "user_tz": 480, "elapsed": 1241318, "user": {"displayName": "amin norouzi", "userId": "02798455485104728835"}} outputId="e7223f19-b319-485b-d045-e09fb7082808"
# lst = [regular_df[regular_df.pointID == _].shape[0] for _ in regular_df.pointID.unique()]
# listt = pd.Series(lst)
# listt.value_counts()


# + id="shmuk0yEmTl7" executionInfo={"status": "error", "timestamp": 1677022039324, "user_tz": 480, "elapsed": 12, "user": {"displayName": "amin norouzi", "userId": "02798455485104728835"}} colab={"base_uri": "https://localhost:8080/", "height": 232} outputId="f81f5796-9093-40fa-bb8a-ec2eb55eb365"
