...
# On my Mac
setwd('/Users/aminnorouzi/Library/CloudStorage/GoogleDrive-msaminnorouzi@gmail.com/My Drive/PhD/Projects/Spectroscopy paper/EPO/')
...
Crop_original <- read.csv("Soil_08_18.csv")

Crop_original <- dplyr::rename(Crop_original, Type_Name = Crop)
