...
# names(CAI) <- c("Sample", "Scan", "Crop", "RWC", "X1600", "X1660", "X2000", "X2100", "X2200", 
#                "X2205", "X2260", "X2330", "CAI", "SINDRI", "NDTI", "R2220",  
#                "R1620", "RSWIR", "ROLI")  # Provide the new column names in the desired order
