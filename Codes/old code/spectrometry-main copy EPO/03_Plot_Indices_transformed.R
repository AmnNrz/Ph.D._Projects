...
desired_ResCol <- c("Wvl", "Sample", "Scan", "Crop", "Reflect", "RWC") 
# Reorder the columns
Residue_Median <- Residue_Median[, desired_ResCol]

desired_ResCol <- c("Wvl", "Sample", "Scan", "Crop", "Reflect", "RWC") 
# Reorder the columns
Soil_Median <- Soil_Median[, desired_ResCol]
...
write.csv(CAI, file = "CAI_transformed_Combined.csv", row.names = FALSE)
